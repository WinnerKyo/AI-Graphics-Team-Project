...
##### 머신러닝(기계학습)은 인공지능 분야에서 널리 사용되는 기술이다. 이를 활용하여 사물을 인식 한 후에 사물에 여러 그래픽 효과를 적용해 보고자 한다.
...
- 프로그램에 사진을 삽입 시 사진에서 사물을 추출해내고 아이콘을 입력시 추출 된 사물에 여러 그래픽 효과를 적용 시킨다.

#### 기도효과 및 활용방안

- 인식 된 사물에 그래픽 효과를 적용시킴으로서 다양한 사진들을 제작할 수 있고, 요즘 급부상중인 디자인 표지에 활용 될 수 있다.
